...
public abstract class TeacherServiceFacade
		extends PersonServiceFacade<TeacherEntity, TeacherCreate, TeacherUpdate, TeacherRead> {
	public abstract Set<StudentRead> getStudentsOfTeacher(long id);
}
