...
public abstract class StudentServiceFacade
		extends PersonServiceFacade<StudentEntity, StudentCreate, StudentUpdate, StudentRead> {
	public abstract Set<TeacherRead> getTeachersOfStudent(long id);
